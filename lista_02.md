...
Classe Circulo extende FormaGeometrica:
    ...
    Método Construtor(cor, raio):
        Define o valor do atributo cor com o valor passado como parâmetro.
            - Super(cor): Define o valor do atributo cor com o valor passado como parâmetro.
            - Define o valor do atributo raio com o valor passado como parâmetro.

        Método CalcularArea():
            retonar PI * (raio ^ raio)
...
Classe Retangulo extende FormaGeometrica:
    ...
    Método Construtor(cor, raio, altura):
        Define o valor do atributo cor com o valor passado como parâmetro.
            - Super(cor): Define o valor do atributo cor com o valor passado como parâmetro.
            - Define o valor do atributo base com o valor passado como parâmetro.
...
```
const tempoMaximoSegundos = tempoMaximo * 60
velocidade <- velocidadeInicial
tempo <- 0
distanciaPercorrida <- 0

Enquanto distanciaPercorrida < distancia || tempo < tempoMaximoSegundos faça:
...
Se distanciaPercorrida >= distancia então:
    Escreva "A corrida foi concluída em", tempo / 60, "minutos."
Senão:
    Escreva "O carro não conseguiu completar a corrida dentro do tempo máximo."
```
...
Função MultiplicacaoDeMatrizes(matrizA, matrizB):
    ...
    Senão:
        colunas <- colunas(matrizA)
        linhas <- linhas(matrizB) # Considerando que todas as linhas têm o mesmo número de colunas
        matrizResultado <- novaMatriz(linhas, colunas)
